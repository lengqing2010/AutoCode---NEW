<%@ Page Language="VB" AutoEventWireup="false" CodeFile="m_edp_test.aspx.vb" Inherits="m_edp_test" %>
...
<asp:TextBox ID="tbxedpNo_key" class="" runat="server" style="width:200px;background-color: #FFAA00;"></asp:TextBox>
 ...
 <br> <hr />
      <table class='ms_title' style="width:1028px" cellpadding="0" cellspacing="0">
          <tr>
          ...
          <td style="width:42px;">
              <asp:TextBox ID="tbxstatus" class="jq_status_ipt" runat="server" style="width:32px;"></asp:TextBox>
          </td>
          <td style="width:58px;">
              <asp:TextBox ID="tbxstatus2" class="jq_status2_ipt" runat="server" style="width:48px;"></asp:TextBox>
          </td>
          <td style="">
              <asp:TextBox ID="tbxstatus3" class="jq_status3_ipt" runat="server" style="width:200px;"></asp:TextBox>
          </td>
          </tr>
      </table>
<div id="divGvw" class='jq_ms_div' runat ="server" style="overflow:auto ; height:294px;margin-left:0px; width:1048px; margin-top :0px; border-collapse :collapse ;">
   <asp:GridView CssClass ="jq_ms" Width="1028px"  runat="server" ID="gvMs" EnableTheming="True" ShowHeader="False" AutoGenerateColumns="False" BorderColor="black" CellPadding="0" CellSpacing ="0" style=" margin-top :-1px; " TabIndex="-1" >
      <Columns>
          ...
          <asp:TemplateField><ItemTemplate ><%#Eval("status")%></ItemTemplate><ItemStyle Height="20px" Width="42px" HorizontalAlign="Left" CssClass="jq_status" /></asp:TemplateField>
          <asp:TemplateField><ItemTemplate ><%#Eval("status2")%></ItemTemplate><ItemStyle Height="20px" Width="58px" HorizontalAlign="Left" CssClass="jq_status2" /></asp:TemplateField>
          <asp:TemplateField><ItemTemplate ><%#Eval("status3")%></ItemTemplate><ItemStyle Height="20px"  HorizontalAlign="Left" CssClass="jq_status3" /></asp:TemplateField>
      </Columns>
   </asp:GridView>
</div>
...
<asp:TextBox ID="hidstatus3" runat="server" class="jq_status3_ipt" style=" visibility:hidden;"></asp:TextBox>
    </div>
    </form>
</body>
</html>
